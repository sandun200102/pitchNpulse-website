        ...
        <div className="flex flex-col md:flex-row gap-16 items-center">
          ...
          <div className="w-full md:w-1/2">
            ...
            <p className="text-stone-600 mb-6 leading-relaxed text-lg">
              Aravinda is a graduate-qualified music teacher dedicated to nurturing talent through structured, creative, and practical learning. He holds a <strong>Bachelor of Performing Arts (Special)</strong> Degree from the University of the Visual and Performing Arts, Colombo, Sri Lanka.
            </p>
            <p className="text-stone-600 mb-6 leading-relaxed text-lg">
